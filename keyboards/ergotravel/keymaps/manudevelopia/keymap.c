...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI,           LOWER,   KC_SPC,           KC_SPC,  RAISE,            KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT
  //`--------+--------+--------+--------+--------+--------+--------/        \--------+--------+--------+--------+--------+--------+--------'
  ),

  [_LOWER] = LAYOUT(
  KC_TILD, KC_EXLM,  KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_HOME,          KC_PGUP,     KC_CIRC, KC_AMPR, KC_ASTR,  KC_LPRN, KC_RPRN, KC_DEL,  \
  KC_F1,   KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_END ,          KC_PGDN,     KC_LEFT, KC_UP,   KC_DOWN,  KC_RGHT, KC_FIND, KC_UNDO, \
  KC_F7,   KC_F8,    KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC,          KC_BSPC,     KC_CUT,  KC_COPY, KC_PASTE, KC_VOLD, KC_VOLU, KC_MUTE, \
  _______, _______,  _______, _______, _______, KC_BSPC,                                KC_BSPC, ADJUST,  KC_MPRV,  KC_MSTP, KC_MPLY, KC_MNXT  \

  ),

  [_RAISE] = LAYOUT(
 
  KC_TILD, KC_1,    KC_2,  KC_3,   KC_PLUS, KC_MINS,  _______,          _______,     KC_6,  KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
  _______, KC_4,    KC_5,  KC_6,   KC_PAST, KC_PSLS,  _______,          _______,   _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, \
  _______, KC_7,    KC_8,  KC_9,   KC_ENT,  _______,  _______,          _______,   _______, KC_NUHS, KC_NUBS, KC_VOLD, KC_VOLU, KC_MUTE, \
  _______, KC_COMM, KC_0,  KC_DOT, _______, KC_BSPC,                               KC_BSPC, _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT  \
